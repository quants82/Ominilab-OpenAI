"""Open OmniLab Wi-Fi helper with no subscription gate or device secrets."""
...
def _setup_portal():
    ...
    access_point.config(essid="OmniLab-Setup-" + get_mac()[-4:])
    ...
    <h2>OmniLab ESP32 setup</h2><p>Device ID: <b>{device}</b></p>
